...
const features = [
  {
    title: "Hồ sơ xe & lịch sử dịch vụ",
    desc: "Mỗi biển số một hồ sơ — tra cứu toàn bộ lần vào xưởng trong vài giây.",
  },
  {
    title: "Lệnh sửa chữa từ tiếp nhận tới giao xe",
    desc: "Báo giá, giao việc cho kỹ thuật viên, theo dõi tiến độ trên cùng một phiếu.",
  },
  {
    title: "Kho phụ tùng & nhắc bảo dưỡng tự động",
    desc: "Cảnh báo phụ tùng sắp hết, nhắc khách tới hạn bảo dưỡng không cần ai nhớ.",
  },
];
      ...
      <div className="relative z-10 flex w-full max-w-5xl min-h-screen flex-col overflow-hidden border-white/[0.06] bg-[rgba(10,10,14,0.6)] sm:my-10 sm:min-h-0 sm:flex-row sm:rounded-3xl sm:border sm:shadow-[0_25px_80px_rgba(0,0,0,0.8)] sm:backdrop-blur-2xl">
        <div className="flex flex-col justify-center border-b border-white/[0.06] p-8 sm:flex-[1.2] sm:border-r sm:border-b-0 sm:p-14">
          <div className="mb-5 flex items-center gap-4">
            <span className="bg-gradient-to-br from-orange-400 to-amber-300 bg-clip-text text-4xl text-transparent">
              ▲
            </span>
            <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl">{brandTitle}</h1>
          </div>
          <p className="mb-9 max-w-md text-[15px] leading-relaxed text-zinc-400">{brandSubtitle}</p>
